  ...
  return (
    <nav style={styles.header}>
      ...
      <div style={styles.buttons}>
        ...
        <button style={styles.button} onClick={() => window.open("https://pancakeswap.finance/?outputCurrency=0x89681d466CC6419d740b71307B65b4e7AF8F6997", "_blank")}>BUY NOW</button>
      ...
      {isMobile && menuOpen && (
        <>
          ...
          <div style={styles.mobileMenu}>
            ...
            <button style={styles.hamburgerButton} onClick={() => window.open("https://pancakeswap.finance/?outputCurrency=0x89681d466CC6419d740b71307B65b4e7AF8F6997", "_blank")}>BUY NOW</button>
          </div>
        </>
      )}
    </nav>
